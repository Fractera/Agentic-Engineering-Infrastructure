...
export const NAV = [
  ...
  // 🔒 РЕЕСТР ПРИЗНАКОВ ПАМЯТИ — В ГРУППЕ «ДАННЫЕ», РЯДОМ С ХРАНИЛИЩАМИ (шаг памяти 205-6).
  // Это не настройка проекта и не способ входа: это словарь того, ЧТО память понимает, и карта
  // того, КТО этим пользуется. Соседи по группе — вектор и граф, то есть те же склады знания.
  { slug: "feature-registry", group: "data" },
  { slug: "map",             group: "data" },
